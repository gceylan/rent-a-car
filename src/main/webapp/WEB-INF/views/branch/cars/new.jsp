...
<c:url var="action" value='/branch/cars/new' />

<div class="row">
	<div class="col-lg-6">
		<form:form accept-charset="UTF-8" commandName="car" action="${ action }" method="post" cssClass="form-horizontal" role="form">
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="licensePlate" cssClass="text-danger" /></p>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="brand" cssClass="text-danger" /></p>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="model" cssClass="text-danger" /></p>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="color" cssClass="text-danger" /></p>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="owner" cssClass="text-danger" /></p>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="ownerEmail" cssClass="text-danger" /></p>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="ownerPhone" cssClass="text-danger" /></p>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<p class="help-block"><form:errors path="pricePerDay" cssClass="text-danger" /></p>
				</div>
			</div>			
			<div class="form-group">
				<div class="col-lg-offset-3 col-lg-9">
					<button type="submit" class="btn btn-default">Aracı Ekle</button>
				</div>
			</div>
		</form:form>
	</div>
