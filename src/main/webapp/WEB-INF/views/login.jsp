...
<script type="text/javascript" src="<c:url value='/resources/bootstrap/js/jquery.js' />"></script>
<script type="text/javascript" src="<c:url value='/resources/bootstrap/js/bootstrap-alert.js' />"></script>
				...
				<form method="POST" accept-charset="UTF-8" action="<c:url value="j_spring_security_check" />">
					...
					<c:if test="${ error }">
						<div class="alert alert-danger alert-dismissable">
							...
							<strong>Hata!</strong> Geçersin Kullanıcı Adı ve/veya Parola
						</div>
					</c:if>
