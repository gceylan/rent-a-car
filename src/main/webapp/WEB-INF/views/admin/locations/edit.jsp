...
<div class="row">
	<div class="col-lg-6">
		<form:form cssClass="form-horizontal" role="form" commandName="location" method="post" accept-charset="ISO-8859-9" action="${ pageContext.request.contextPath }/admin/locations/edit/${ location.id }">
