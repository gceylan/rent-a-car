...
<div class="row">
	<c:url var="editBranchUrl" value="/admin/branchs/edit/${ editBranchForm.branch.id }" />
	<form:form cssClass="form-horizontal" role="form" method="POST" accept-charset="UTF-8" action="${ editBranchUrl }" commandName="editBranchForm">
		<fieldset>
		<div class="col-lg-6">
		...
		<div class="form-group">
			<div class="col-lg-12">
				<button type="submit" class="btn btn-default btn-block">Güncelle</button>
			</div>
		</div>
	</form:form>
</div>