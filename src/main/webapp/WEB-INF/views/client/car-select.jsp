				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Araçlar<small> Kiralamak istediğiniz aracı seçin</small>
						</h1>
					</div>
				</div>
				
				<c:if test="${ !empty rentableCarList }">
					<c:forEach items="${ rentableCarList }" var="car">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								<a href="#"><img class="img-responsive" src="http://placehold.it/250x180"></a>
							</div>
							<div class="col-lg-6 col-md-6">
<%-- 								<h3>${ car.brand }</h3> --%>
								<h4>${ car.brand } ${ car.model }</h4><span>${ car.branch.county } arabası</span>
								<ul>
									<li>Kapı Sayısı: 5</li>
									<li>Klima: Evet</li>
									<li>Yakıt: Dizel</li>
									<li>Vites: Otomatik</li>
									<li>Vites: Otomatik</li>
									<li>Fiyat: ${ car.pricePerDay } TL (Günlük)</li>
								</ul>
							</div>
							<div class="col-lg-2 col-md-2" style="margin-top: 140px;">
								<a style="float: right;" class="btn btn-primary" href="<c:url value='car/${ car.id }' />">Seç <span class="glyphicon glyphicon-chevron-right"></span></a>
							</div>
						</div>
						<hr>
					</c:forEach>
